...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left dont-print" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    <div class="w3-col s4">
      <img src="img/pig14.jpg" class="w3-circle w3-margin-right" style="width:46px">
    </div>
  ...
  <div class="w3-bar-block">
    ...
    <a href="manage-pig.php" class="w3-bar-item w3-button w3-padding <?= $url == '/manage-pig.php' || $url == '/add-pig.php' || str_contains($url ,'/edit-pig.php') || str_contains($url ,'/quarantine.php') || str_contains($url ,'/sold.php') || str_contains($url ,'/sold-all.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Pigs</a>
    <a href="manage-anay.php" class="w3-bar-item w3-button w3-padding <?= $url == '/manage-anay.php' || str_contains($url, '/edit-anay.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Sow Pigs</a>
    ...
    <a href="manage-cage1.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage1.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Cage 1</a>
    <a href="manage-cage2.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage2.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Cage 2</a>
    <a href="manage-cage3.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage3.php') ? $active : '' ?>"><i class="fa fa-eye fa-fw" style="color: #c6322d !important;"></i> Manage Cage 3</a>
