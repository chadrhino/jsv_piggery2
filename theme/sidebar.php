...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left dont-print" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="manage-cage1.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage1.php') ? $active : '' ?>"><i class="fa fa-sort fa-fw" style="color: #c6322d !important;"></i> Manage Cage 1</a>
    <a href="manage-cage2.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage2.php') ? $active : '' ?>"><i class="fa fa-sort fa-fw" style="color: #c6322d !important;"></i> Manage Cage 2</a>
    <a href="manage-cage3.php" class="w3-bar-item w3-button w3-padding <?= str_contains($url, '/manage-cage3.php') ? $active : '' ?>"><i class="fa fa-sort fa-fw" style="color: #c6322d !important;"></i> Manage Cage 3</a>
