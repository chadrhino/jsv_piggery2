...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT id FROM users WHERE phone = ? AND SMSOTP = ? AND OTP_TIMESTAMP > NOW() - INTERVAL 15 MINUTE");
